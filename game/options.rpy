...
init -1 python hide:
    ...
    config.window_title = u"dervish_alfa"
...
python early:
    config.save_directory = "dervish_alfa-1501671082"
...
init python:
    ...
    build.directory_name = "dervish_alfa-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "dervish_alfa"
